  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px", marginBottom: "40px" }}>
        {[
          { label: "Umbra Status", value: "Not Registered", sub: "Register to start", color: "var(--red)", dimColor: "var(--red-dim)" },
          { label: "Private Balance", value: "— USDC", sub: "Encrypted onchain", color: "var(--cyan)", dimColor: "var(--cyan-dim)" },
          { label: "Payroll Runs", value: "0", sub: "This month", color: "var(--green)", dimColor: "var(--green-dim)" },
          { label: "Team Members", value: "0", sub: "Recipients added", color: "var(--cyan)", dimColor: "var(--cyan-dim)" },
        ].map((s) => (
          <div key={s.label} style={{
            padding: "24px", borderRadius: "12px",
            background: "var(--bg-card)", border: "1px solid var(--border)"
          }}>
            <p style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "var(--text-muted)", letterSpacing: "0.05em", marginBottom: "12px" }}>
              {s.label}
            </p>
            <p style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "22px", color: s.color, marginBottom: "4px" }}>
              {s.value}
            </p>
